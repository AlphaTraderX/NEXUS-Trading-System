...
Connects to Massive.com (formerly Polygon.io) for US stock market data.
...
class MassiveProvider(BaseDataProvider):
    ...
    # API hosted at polygon.io (Polygon rebranded to Massive but endpoint unchanged)
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            if response.get("status") in ("OK", "DELAYED"):
